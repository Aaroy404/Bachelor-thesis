...
Frekventant je pojem označujúci akúkoľvek osobu s aktívnym vzťahom k univerzite (pracovný úväzok, štúdium), ktorej vzniká povinnosť absolvovať nejaké školenie.~\cite[\nopp{2.1}]{Gabi-bakina}

Vedúci zamestnanec predstavuje osobu, ktorá je formálne vedená ako nadriadený pre skupinu zamestnancov a ktorá dohliada na absolvovanie školení svojimi podriadenými.~[3, 2.1]
Absolvent školenia je frekventant, ktorý splnil dané školenie.
Zamestnávateľ je od zákona povinný udržiavať dokumentáciu o školeniach BOZP a PO, ktoré frekventanti absolvovali. Z tohto dôvodu Informačný systém Masarykovej univerzity (ďalej len IS MU) vytvára Záznamy pre školenia, ktorých sa táto povinnosť týka.~\cite[§~103~odst.~3,~2,~§~27]{Gabi-bakina}

Záznam v kontexte dokumentácie BOZP a PO v IS MU je dokument formátu PDF, ktorý obsahuje všetky dôležité informácie potrebné k preukázaniu, že daný frekventant školenie naozaj absolvoval. Tieto informácie zahŕňajú najmä:
