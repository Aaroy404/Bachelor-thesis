...
Samotná podpisová časť v zadaní na jej splnenie žiada frekventanta o podpis Potvrdenia. Frekventantovi zobrazí podpisované údaje, aby ich mohol skontrolovať a aby bol informovaný o obsahu dokumentu, ktorý podpisuje. Pod informáciami sa nachádza tlačidlo s nápisom \enquote{Podepsat}, ktoré Potvrdenie podpíše a odovzdá do spisovej služby Úradovne.
MOZNO OBRAZOK PODPISOVEJ CASTI
...
Pracovisko, ktoré má spravovať spis Potvrdenia nie je s príkazom ani so školením priamo spojené. Preto ako identifikačné číslo pracoviska používame algoritmicky spočítané \textbf{kanonické pracovisko}.
\begin{description}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \item Použije sa predvolené pracovisko, ktorým je Prevádzkový odbor rektorátu MU.
        \end{itemize}
    \end{enumerate}
\end{description}
