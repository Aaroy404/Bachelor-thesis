...
Podľa dohody odovzdávam úvod aj opravu prehľadovej kapitoly spolu. Za túto možnosť ďakujem :)
\chapter*{Úvod}
...
Jednou z dôležitých požiadaviek na prevádzku školení bezpečnosti a ochrany zdravia pri práci a požiarnej ochrany je udržiavanie dokumentácie o ich absolvovaní frekventantmi. Z právnych dôvodov totiž musí byť preukázateľné, že bol daný frekventant korektne zaškolený vo všetkých preňho relevantných smeroch.

Je nutné, aby táto dokumentácia bola v prípade potreby z právneho hľadiska nevyvrátiteľná. Kvôli tomu musí byť potvrdená ako absolventom školenia, tak aj jeho školiteľom. Informačný systém Masarykovej univerzity používa na toto potvrdenie záznamov fyzický podpis oboch entít.

Cieľom tejto práce je previezť proces potvrdzovania dokumentácie na Masarykovej univerzite do online formy implementáciou potvrdení s jednoduchým elektronickým podpisom. Zároveň je súčasťou taktiež aj následný prevod spisov tejto dokumentácie do elektronickej formy. Tieto zmeny uľahčia prácu všetkých zúčastnených strán prevádzky školení.

Ako prvé som musel preskúmať všetky rôzne právne a používateľské požiadavky na udržiavanú dokumentáciu (kapitoly 1 a 2). Následne som upravil funkcionalitu tvorby záznamov tak, aby odpovedala novej forme využívajúcej elektronický podpis (kapitola 3) a pridal možnosť samotného elektronického podpisu a zapečatenia systémom v aplikácii Úřadovna (kapitola 4).  Ako posledné bolo potrebné spojiť nové dokumenty s ich relevantnými elektronickými spismi v aplikácii Úschovna (kapitola 5).

Výsledné úpravy systému umožňujú frekventantom potvrdiť absolvovanie školenia priamo v aplikácii BOZP a zaručujú potvrdenie školiteľa (systému). Nové potvrdenia o absolvovaní školenia podpísané elektronicky spĺňajú všetky požiadavky na spravovanie dokumentácie BOZP a PO.

\chapter{Prechod zo záznamov na potvrdenia}

V tejto práci sú použité pojmy označujúce osoby, ktoré majú spojenie so školeniami bezpečnosti a ochrany zdravia pri práci (ďalej len BOZP) a školeniami požiarnej ochrany (ďalej len PO). Kvôli prehľadnosti ich v tejto kapitole definujem:
...
\section{Povinnosť dokumentovať BOZP a PO}
Zamestnávateľ je od zákona povinný udržiavať dokumentáciu o tom, že frekventanti absolvovali školenia BOZP a PO. Z tohto dôvodu Informačný systém Masarykovej univerzity (ďalej len IS MU) vytvára pre školenia, na ktoré sa táto povinnosť vzťahuje, záznamy.~\cites[§~103~odst.~3]{cesko_zakonik_prace}[§~27]{cesko_vyhlaska_poziarna_prevence}

\section{Záznamy}
\textbf{Záznam} v kontexte dokumentácie BOZP a PO v IS MU je dokument formátu PDF. Obsahuje všetky dôležité informácie potrebné k preukázaniu, že daný frekventant školenie naozaj absolvoval.

Tieto informácie zahŕňajú najmä nasledujúce informácie:
...
Všetky súčasti záznamov sú z legálneho hľadiska dôležité. Ich komplexnosť ale so sebou prináša niektoré komplikácie, ktoré ich robia neefektívnymi.

Aby záznamov nebolo príliš veľa, sú školenia delené do skupín podľa typov. Po absolvovaní školení systém všetky absolvované školenia daného typu pozbiera a postaví z nich jeden záznam. Tento záznam obsahuje spojené informácie o všetkých školeniach, ktoré sa v ňom nachádzajú.

Problém ale nastáva, keď rôzne školenia rovnakého typu požadujú podpisy iných vedúcich zamestnancov alebo odovzdanie inej osobe zodpovednej za uchovávanie záznamov. Potom je potrebné tento záznam duplikovať a v každej kópii uviesť inú osobu pre danú rolu.

Pre niektoré záznamy sa vyžaduje, aby boli vytlačené do papierovej formy a fyzicky podpísané absolventom aj vedúcim zamestnancom školenia. IS MU prevádzkuje školenia prevažne vo forme online kurzov.

Pre určovanie osoby zodpovednej za preškolenie daného zamestnanca je preto potreba identifikovať jeho priameho nadriadeného alebo inú osobu poverenú zamestnanca preškoľovať. Pri záznamoch s viacerými školeniami je táto akcia ale zbytočne náročná a vytvára konfliktné situácie.

Po podpísaní záznamu je potrebné ho odovzdať osobe zodpovednej za správu dokumentácie o absolvovaní BOZP a PO.

Táto osoba môže byť rozdielna od vedúceho zamestnanca. Zároveň je touto úlohou častokrát poverená iná osoba pre rôzne pracoviská a typy školení. Záznamy špecifických školení je dokonca potrebné odovzdať na všetky aktívne pracoviská zamestnanca, ktoré toto školenie požadujú.

Zoznam osôb, ktorým treba daný záznam odovzdať, je tým pádom tiež často problematický.
