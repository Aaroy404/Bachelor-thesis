...
Presnejšie vymedzenia platnosti jednotlivých elektronických podpisov si upravujú členské štáty vo vlastnej štátnej legislatíve. Pre potreby dokumentácie školení BOZP a PO je možné použiť akýkoľvek druh elektronického podpisu.~\cite[§~7]{cesko_el_podpisy}
...
Na účely elektronickej identifikácie bol po konzultácii s Právnym odborom MU bol zvolený jednoduchý elektronický podpis, pretože je podľa zákona dostačujúci (vysvetlené v kapitole~\hyperref[kap-4]{4}) a praktickejší pre používateľov, pretože nevyžaduje vlastníctvo špeciálneho certifikátu alebo zariadenia. Zaručený a kvalifikovaný elektronický podpis sú síce bezpečnejšie, avšak ich získanie je náročnejšie z administratívneho aj technického hľadiska, keďže vyžadujú certifikáciu od kvalifikovaných poskytovateľov dôveryhodných služieb a často aj používanie bezpečnostného hardvéru.

\section{Presun Záznamov do aplikácie Úradovňa}
Pôvodný zámer správy Záznamov bol, že po ich vytlačení budú v papierovej forme podpísané školiteľom aj absolventom a následne naskenované a vložené do digitálneho spisu absolventa. Riešenie by využilo funkcionalitu aplikácie Úradovňa pre spracovávanie papierových dokumentov do spisov.
