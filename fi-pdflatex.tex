...
\begin{itemize}
  ...
  \item nemení podpisované dáta~a nebráni tomu, aby tieto dáta boli pred podpísaním predložené podpisujúcej osobe.
\end{itemize}~\cite[príloha II]{eidas2024}
...
\begin{itemize}
    ...
    \item je pripojený k dátam, ktoré podpisuje, takým spôsobom, aby bolo možné zistiť ich akúkoľvek následnú zmenu.
\end{itemize}~\cite[čl.~26]{eidas2024}
...
Presnejšie vymedzenia platnosti jednotlivých elektronických podpisov si upravujú členské štáty vo vlastnej štátnej legislatíve. Pre potreby dokumentácie školení BOZP a PO je možné použiť akýkoľvek druh elektronického podpisu vrátane jednoduchého elektronického podpisu.~\cite[§~7]{cesko_el_podpisy}
...
Na účel elektronickej identifikácie dokumentácie bol po konzultácii s Právnym odborom MU bol zvolený jednoduchý elektronický podpis, pretože je podľa zákona dostačujúci (vysvetlené v kapitole~\hyperref[kap-4]{4}) a praktickejší pre používateľov, pretože nevyžaduje vlastníctvo špeciálneho certifikátu ani zariadenia. Zaručený a kvalifikovaný elektronický podpis sú síce bezpečnejšie, avšak ich získanie je náročnejšie z administratívneho aj technického hľadiska, keďže vyžadujú certifikáciu od kvalifikovaných poskytovateľov dôveryhodných služieb a často aj používanie bezpečnostného hardvéru.
