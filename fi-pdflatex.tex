...
\noindent
\textbf{Identifikačné číslo pracoviska:} Unikátny kód priradený pracovisku, ktoré spravuje spis Potvrdenia. Toto pracovisko nie je s príkazom ani so školením priamo spojené. Preto ako identifikačné číslo pracoviska používame \textbf{Kanonické pracovisko}.

Kanonické pracovisko 
